...
public class ReviewDetailView$$ViewBinder<T extends components.ReviewDetailView> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131690051, "field 'review_title'");
    target.review_title = finder.castView(view, 2131690051, "field 'review_title'");
    view = finder.findRequiredView(source, 2131690050, "field 'review_user'");
    target.review_user = finder.castView(view, 2131690050, "field 'review_user'");
    view = finder.findRequiredView(source, 2131690052, "field 'review_date'");
    target.review_date = finder.castView(view, 2131690052, "field 'review_date'");
    view = finder.findRequiredView(source, 2131690054, "field 'review_text'");
    target.review_text = finder.castView(view, 2131690054, "field 'review_text'");
    view = finder.findRequiredView(source, 2131690056, "field 'review_reply_et'");
    target.review_reply_et = finder.castView(view, 2131690056, "field 'review_reply_et'");
    view = finder.findRequiredView(source, 2131690057, "field 'review_reply_btn'");
    target.review_reply_btn = finder.castView(view, 2131690057, "field 'review_reply_btn'");
